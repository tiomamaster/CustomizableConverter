 ...
 */
public final class ConverterServiceApiEndpoint {

    private static final String TAG = "ServiceApiEndpoint";

    private static Context c;

    private static ConvertersDatabase db;

    private static final class ConvertersDatabase extends SQLiteOpenHelper {
        ...
        public ConvertersDatabase(String name) {
        ...
        private String[] getAllConvertersName() {
        ...
        private Converter createConverter(String name) {
            SQLiteDatabase db = getReadableDatabase();
    ...
    static String[] getAllConvertersName() {
        return db.getAllConvertersName();
    }

    static Converter createConverter(String name) {
        return db.createConverter(name);
    }

     static void initialize(Context context) {
         c = context;
         String language = Locale.getDefault().getLanguage();
         db = new ConvertersDatabase(language);
    }
}